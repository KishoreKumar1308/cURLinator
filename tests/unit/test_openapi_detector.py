        ...
        "paths": {
            "/pets": {
                ...
                "post": {
                    ...
                    "tags": ["pets", "admin"],
                    "requestBody": {"description": "Pet object to create", "required": True},
                    "responses": {
...
def sample_swagger_2_spec():
    ...
    return {
        "swagger": "2.0",
        "info": {"title": "User API", "version": "2.0.0", "description": "User management API"},
...
class TestDetectFromSwaggerUI:
    ...
    @pytest.mark.asyncio
    async def test_detects_spec_from_relative_url(self, mock_http_client, swagger_ui_html_relative):
...
class TestDetectOpenapiSpec:
    ...
    @pytest.mark.asyncio
    async def test_detects_spec_from_direct_url(self, mock_http_client, sample_openapi_3_spec):
    ...
    @pytest.mark.asyncio
    async def test_detects_spec_from_common_path(self, mock_http_client, sample_openapi_3_spec):
...
"""
    ...
    async def test_returns_none_when_no_spec_found(self, mock_http_client):
        ...
        # All requests fail
        mock_http_client.get = AsyncMock(
            side_effect=[swagger_response, *[httpx.HTTPError("Not found") for _ in range(30)]]
        )
...
class TestParseOpenapiToDocuments:
    ...
    async def test_parses_openapi_3_spec_to_documents(
        ...
        documents = await parse_openapi_to_documents("https://api.petstore.com/openapi.json")
    ...
    async def test_parses_swagger_2_spec_to_documents(
        ...
        documents = await parse_openapi_to_documents("https://api.example.com/swagger.json")
    ...
    @pytest.mark.asyncio
    async def test_creates_overview_document(self, mock_http_client, sample_openapi_3_spec):
    ...
    @pytest.mark.asyncio
    async def test_creates_endpoint_documents(self, mock_http_client, sample_openapi_3_spec):
    ...
    @pytest.mark.asyncio
    async def test_flattens_tags_metadata_for_chroma(self, mock_http_client, sample_openapi_3_spec):
    ...
    @pytest.mark.asyncio
    async def test_creates_auth_document(self, mock_http_client, sample_openapi_3_spec):
...
"""
        ...
        documents = await parse_openapi_to_documents("https://api.example.com/openapi.yaml")
...
class TestHelperFunctions:
    ...
    def test_create_overview_document(self, sample_openapi_3_spec):
        ...
        doc = _create_overview_document(
            sample_openapi_3_spec, "https://api.petstore.com/openapi.json", "3.0.0"
        )
    ...
    def test_create_endpoint_documents(self, sample_openapi_3_spec):
        ...
        docs = _create_endpoint_documents(
            sample_openapi_3_spec, "https://api.petstore.com/openapi.json", is_openapi_3=True
        )
    ...
    def test_create_auth_document_swagger_2(self, sample_swagger_2_spec):
        ...
        doc = _create_auth_document(
            sample_swagger_2_spec, "https://api.example.com/swagger.json", is_openapi_3=False
        )

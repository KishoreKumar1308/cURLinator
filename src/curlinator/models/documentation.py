...
class CodeExample(BaseModel):
    ...
    context: Optional[str] = None  # What page/section it came from
...
class APISectionSummary(BaseModel):
    ...
    webhooks_info: Optional[str] = None
...
class DocumentationPage(BaseModel):
    ...
    summary: Optional[PageSummary] = None  # Analyzed summary (optional)
    crawled_at: datetime = Field(default_factory=datetime.utcnow)
...
class OpenAPIInfo(BaseModel):
    ...
    spec_content: Optional[dict[str, Any]] = None  # The actual OpenAPI spec
...
class DocumentationSource(BaseModel):
    ...
    openapi_info: Optional[OpenAPIInfo] = None

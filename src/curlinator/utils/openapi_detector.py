...
async def _detect_from_swagger_ui(url: str) -> Optional[str]:
    """
...
async def detect_openapi_spec(url: str) -> Optional[str]:
    """
...
def _create_auth_document(spec_data: Dict, spec_url: str, is_openapi_3: bool) -> Optional[Document]:
